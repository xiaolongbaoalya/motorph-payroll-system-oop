...
public class Attendance {
    ...
    private String status; // Added for On Time / Late logic

    public Attendance() {
        // Empty constructor for JavaFX/Persistence frameworks
    }
    ...
    public double getHoursWorked() {
        ...
        // Using Duration.toSeconds() / 3600.0 provides better precision for partial minutes
