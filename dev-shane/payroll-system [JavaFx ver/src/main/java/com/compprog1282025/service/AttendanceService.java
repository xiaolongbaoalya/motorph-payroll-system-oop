...
public class AttendanceService {
    ...
    public List<Attendance> getTeamAttendance(int month, int year) {
        return attendanceDao.getAll().stream()
                .filter(a -> a.getDate().getMonthValue() == month)
                .filter(a -> a.getDate().getYear() == year)
                .collect(Collectors.toList());
    ...
    public List<Attendance> getEmployeeAttendanceHistory(int employeeNumber, LocalDate fromDate, LocalDate toDate) {
        return attendanceDao.getAll().stream()
                .filter(a -> a.getEmployeeNumber() == employeeNumber)
