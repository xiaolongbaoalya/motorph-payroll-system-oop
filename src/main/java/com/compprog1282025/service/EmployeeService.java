...
public class EmployeeService {
    ...
    public List<Employee> getAllEmployees(Session session) throws InvalidAccessException {
        ...
        if (role != EffectiveRole.HR && role != EffectiveRole.FINANCE && role != EffectiveRole.ADMIN) {
    ...
    public void validateEmployeeData(Employee employee) {
        ...
        employee.getGovernmentID().setSss(InputValidationService.requireGovernmentId("SSS #", employee.getGovernmentID().getSss()));
        employee.getGovernmentID().setPhilHealth(InputValidationService.requireGovernmentId("PhilHealth #", employee.getGovernmentID().getPhilHealth()));
        employee.getGovernmentID().setTin(InputValidationService.requireGovernmentId("TIN #", employee.getGovernmentID().getTin()));
        employee.getGovernmentID().setPagIbig(InputValidationService.requireGovernmentId("Pag-IBIG #", employee.getGovernmentID().getPagIbig()));
