...
class RbacAndRequestPersistenceTest {
    ...
    void restoreData() throws IOException {
        Files.write(EMPLOYEES_CSV, employeesSnapshot);
        Files.write(ATTENDANCE_CSV, attendanceSnapshot);
        Files.write(REQUESTS_CSV, requestsSnapshot);
        Files.write(USERS_CSV, usersSnapshot);
    }
    ...
    void leaveRequestGeneratesCollisionSafeIdWhenBlank() {
        ...
        assertTrue(generatedIdReq.getRequestId() != null && generatedIdReq.getRequestId().startsWith("REQ-"));
    ...
    private Employee newEmployee(int employeeNumber) {
        return new Employee(
                ...
                new GovernmentID("12-3456789-0", "12345678901", "123-456-789", "1234-5678-9012"),
